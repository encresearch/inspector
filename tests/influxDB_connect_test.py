...
class Database():
	...
	def addData(self, time_precise, date, gas_sensor_data, current_sensor_data, magnetometer_sensor_data):

		add_data_query = f"INSERT INTO \"sensorData\" (time_precise, date, gas_sensor, current_sensor, magnetometer_sensor) values ({time_precise},TIMESTAMP '{date}',{gas_sensor_data},{current_sensor_data},{magnetometer_sensor_data})"
